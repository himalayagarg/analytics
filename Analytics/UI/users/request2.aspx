<%@ Page Title="Analytics (V1.0)" Language="C#" MasterPageFile="~/UI/users/users.master" AutoEventWireup="true" CodeFile="request2.aspx.cs" 
    Inherits="UI_users_request2" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>        
            ...
            <table style="width:100%;" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddl_project" runat="server" AutoPostBack="True" 
                                        onselectedindexchanged="ddl_project_SelectedIndexChanged" AppendDataBoundItems="True">
                                        <asp:ListItem Text="-Select-" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfv_dd_prjname" runat="server" ErrorMessage="*" 
                                        ControlToValidate="ddl_project" InitialValue="0"/>
                                </td>
                                <td>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:DropDownList ID="ddl_lead" runat="server" AppendDataBoundItems="True">
                            <asp:ListItem Text="-Select-" Value="0"></asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="rfv_dd_lead" runat="server" ErrorMessage="*" 
                            ControlToValidate="ddl_lead" InitialValue="0"/>
                    </td>
                    <td align="left">
                        &nbsp;</td>
                </tr>                               
            ...
            <HeaderStyle CssClass="mygridheader"/>
                <Columns>
                    <asp:TemplateField HeaderText="Test Parameter">
                        <ItemTemplate>
                            <asp:TextBox ID="tb_testname" runat="server"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Standard/Limit">
                        <ItemTemplate>
                            <asp:TextBox ID="tb_standard" runat="server"></asp:TextBox>
        ...
        <asp:Panel ID="Panel6" runat="server" CssClass="mypanel" GroupingText="Select Samples for the Tests">            
            <asp:GridView ID="gv_test_sample" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="mygrid" 
                onrowcreated="gv_test_sample_RowCreated" ondatabound="gv_test_sample_DataBound" 
        ...
        <asp:Panel ID="Panel5" runat="server" CssClass="mypanel">
            <asp:Button ID="btn_cancel" runat="server" Text="Cancel" Font-Bold="True" 
                Height="28px" Width="100px" CausesValidation="False" UseSubmitBehavior="False" PostBackUrl="~/UI/users/request1.aspx" />
            <asp:ConfirmButtonExtender ID="cbe_cancel" runat="server" 
                ConfirmText="Are you sure you want to cancel this request? All the form data will be lost." 
                TargetControlID="btn_cancel" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_submit" runat="server" Text="Submit" Font-Bold="True" 
                Height="28px" Width="100px" onclick="btn_submit_Click" 
