<%@ Page Title="Analytics (V1.0)" Language="C#" MasterPageFile="~/UI/admin/admin.master" AutoEventWireup="true" CodeFile="view_request.aspx.cs" 
    Inherits="UI_admin_view_request" MaintainScrollPositionOnPostback="true"%>
...
<div>
    <asp:Panel ID="pnl_viewResult" runat="server" CssClass="mypanel">
        <table width="100%">                 
            <tr>
                <td> 
                <div class="pageTitle">
...
<div>
    <asp:Panel ID="Pnl_request" runat="server" CssClass="mypanel">    
        ...
        <asp:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server"
                ...
                ImageControlID="Image1" ExpandedImage="~/image/collapse_blue.jpg" 
