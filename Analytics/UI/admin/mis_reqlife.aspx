...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function OpenPDFpopup(requestid) {
            // myPDFwindow = window.open('../users/print_request.aspx?reqid=' + requestid + '&action=pdf', 'PDF', 'toolbar = no,scrollbars = no,resizable = no,top = 200,left = 200,width = 400,height = 400');
            myPDFwindow = window.open('../users/print_request.aspx?reqid=' + requestid + '&action=pdf');
            //myPDFwindow.close();
        }
            ...
            <ContentTemplate>
                <table width="100%">
                    <tr>
                        ...
                        <td align="right">Download<asp:ImageButton ID="imgbtn_excel" runat="server" AlternateText="Excel"
        ...
        <asp:GridView ID="gv_reqs" runat="server" AutoGenerateColumns="False" CssClass="mygrid"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <div>
                            <asp:ImageButton ID="imgBtn_PDF" runat="server" ImageUrl="~/image/pdf.png" AlternateText="PDF" />
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
